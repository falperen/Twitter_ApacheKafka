...
public class SimpleTwitter {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SimpleDateFormat sdf = new java.text.SimpleDateFormat("HH:mm:ss dd-MM-yyyy z");
        ...
        String bootstrapServers = "169.254.32.251:9092";//"169.254.146.215:9092";//"169.254.146.215:9092";//"127.0.0.1:9092";//"192.168.1.9:9092";
                ...
                try {
                    while (true) {
                        ...
                        for (ConsumerRecord<String, String> record : records) {
                            ...
                            System.out.println(ctx.splat(0));
        ...
        app.sse("/sse/*/", client -> {
            ...
            clientExtended.onClose(()->{ clientsExtended.remove(clientExtended);System.out.println("Cloooseeddd!!");});
        });
